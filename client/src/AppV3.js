...
class App extends Component {
  ...
  componentDidMount = async () => {
    try {
      ...
      // getPastEvents() pour récupérer tous les évenements qui se sont passés prédemment.
      // listAddress = tuple / dataStored dans SimpleStorage.sol
  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        <table>
        { console.log(this.state.addresses) /* Pour voir que les informations sont dans "returnValues" */ }
